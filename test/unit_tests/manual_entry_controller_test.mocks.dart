...
// in demo_qr_scanner/test/unit_tests/manual_entry_controller_test.dart.
...
class MockGetxNavigationService extends _i1.Mock
    implements _i7.GetxNavigationService {
  @override
  _i8.Future<T?>? toNamed<T>(
    String? pageName, {
    dynamic arguments,
  }) =>
      (super.noSuchMethod(
